...
class InterpreterTest {
    ...
    public void testV() {
        ...
        // 接受的地址
        System.out.println(Account4bitcoin.publicToBase58Address(BitAccountConfig.MAIN, script.getPk()));
        // 接受的地址
        System.out.println(Account4bitcoin.toBase58(BitAccountConfig.MAIN.getAddressHeader(), ByteUtil.hex("35fbee6a3bf8d99f17724ec54787567393a8a6b1")));
